...
from foxycon.data_structures.statistician_type import YouTubeChannelsData, YouTubeContentData, InstagramContentData, \
    InstagramPageData
...
class InstagramStatistician(StatisticianModuleStrategy):
    ...
    async def get_data(self, object_sn: ResultAnalytics):
        if object_sn.content_type == 'reel':
            ...
            return InstagramContentData(system_id=data.media_id,
                                        ...
                                        author=InstagramPageData(user_id=data.author.user_id,
                                                                 username=data.author.username,
                                                                 full_name=data.author.full_name,
                                                                 page_url=f'https://www.instagram.com/'
